...
LexiKeep can import a JSON dictionary pack from the Files page. The pack is merged into the local SQLite cache and is available without a network connection.

LexiKeep also includes a compact ECDICT-derived core dictionary. It is loaded into
...
For Chinese learning, LexiKeep bundles a CC-CEDICT-derived dictionary (simplified
...
LexiKeep also bundles dictionaries for Japanese (JMdict, CC BY-SA 4.0) and German
