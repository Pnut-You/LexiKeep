(function () {
  var I18N = {
    zh: {
      metaTitle: "LexiKeep — 从真实阅读中记住词汇",
      metaDesc: "LexiKeep — Local-first 词汇学习与阅读工具。把你正在读的内容，变成真正记得住的词汇。",
      themeToggle: "切换明暗主题",
      nav: { features: "产品亮点", workflow: "怎么用", privacy: "隐私", languages: "支持语言", support: "参与贡献" },
      hero: {
        eyebrow: "Local-first · 开源 · 离线优先",
        title: "把你正在读的内容，<br><span class=\"gradient-text\">变成真正记得住的词汇。</span>",
        sub: "LexiKeep 是一款本地优先的阅读学习工具。导入文章、字幕或自己的文本，边读边查、随手积累生词，再用智能复习把它们真正记下来。",
        ctaDownload: "免费下载",
        ctaGithub: "查看 GitHub",
        hint: "点击左侧标签，预览每个功能"
      },
      mock: {
        windowTitle: "LexiKeep · 阅读",
      ...
      features: {
        kicker: "为什么选择 LexiKeep",
        title: "不把阅读打断成查词，<br>而是把阅读连接成学习。",
        sub: "围绕你真正在读的内容展开：边读边懂、随手积累，复习交给 LexiKeep。"
      },
      f1: {
      ...
      f6: {
        title: "AI 是可选项，不是使用前提",
        desc: "即使完全不用 AI，导入、阅读、查词、入库和复习都能正常使用。需要额外的段落解释或翻译时再开启即可，默认保持关闭。"
      },
      roadmap: {
        badge: "2.0.0 · 下一版本预告",
        title: "不必在 App 内阅读，也能随手查词并入库",
        desc: "规划中的插件能力将支持在网页或其他阅读场景中选中单词、查看翻译，并一键保存到 LexiKeep 个人单词库，无需把阅读内容搬进 App。",
        p1: "在 App 外自由阅读",
        p2: "选词即可查看翻译",
        p3: "一键存入 LexiKeep"
      },
      ...
      s1: { title: "导入", desc: "把文章、字幕或 YouTube 字幕放进 LexiKeep。" },
      ...
      cta: {
        ...
        starAsk: "喜欢 LexiKeep？点个 Star 支持一下吧",
        support: "喜欢 LexiKeep？欢迎在 GitHub 上点 Star 或参与贡献 ❤",
        notice: "安装包目前为未签名构建，首次安装可能触发系统安全提示，<a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">按安装说明操作即可</a>。"
      },
      footer: { tagline: "LexiKeep · 本地优先的阅读学习工具", github: "GitHub", license: "MIT License", support: "参与贡献" },
      dl: {
        kicker: "下载",
        title: "选择你要安装的设备",
        ...
        note: "安装包为未签名构建，首次安装系统会给出安全提示，属于正常现象。<a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">按安装说明处理即可</a>。",
        all: "不确定？查看全部版本 →"
      }
    },

    en: {
      metaTitle: "LexiKeep — Learn vocabulary from real reading",
      metaDesc: "LexiKeep — a local-first reading tool that turns what you read into vocabulary you remember.",
      themeToggle: "Toggle light / dark theme",
      nav: { features: "Features", workflow: "How it works", privacy: "Privacy", languages: "Languages", support: "Contribute" },
      hero: {
        ...
        sub: "LexiKeep is a local-first reading tool that builds vocabulary as you read. Import an article or subtitles, look words up on the spot, and let smart review make them stick.",
        ctaDownload: "Download free",
        ctaGithub: "View on GitHub",
        hint: "Click the tabs on the left to preview each feature"
      },
      mock: {
        windowTitle: "LexiKeep · Reading",
      ...
      features: {
        ...
        sub: "Everything revolves around the content you actually read: understand on the fly, collect as you go, and let LexiKeep handle the review."
      },
      f1: {
      ...
      f6: {
        title: "AI is optional, never required",
        desc: "Import, read, look up words, save them and review — everything works without AI. Turn it on only when you want extra explanations or translations."
      },
      roadmap: {
        badge: "2.0.0 · Coming next",
        title: "Read anywhere, keep words in LexiKeep",
        desc: "Planned plugin support will let you translate selected words outside the app and save them directly to your LexiKeep word library — without moving your reading into the app.",
      ...
      cta: {
        ...
        star: "Star on GitHub ⭐",
        starAsk: "Enjoying LexiKeep? Give it a star on GitHub",
        support: "Enjoying LexiKeep? Star or contribute on GitHub ❤",
        notice: "Installers are currently unsigned — your system may show a security warning on first install. <a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">See the install guide</a>."
      },
      footer: { tagline: "LexiKeep · Local-first reading & vocabulary tool", github: "GitHub", license: "MIT License", support: "Contribute" },
      dl: {
        kicker: "Download",
        ...
        note: "Installers are unsigned — your system may warn you on first install. That's expected. <a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">See the install guide</a>.",
        all: "Not sure? View all releases →"
      }
    },

    ja: {
      metaTitle: "LexiKeep — 好きなものを読んで、単語を覚える",
      metaDesc: "LexiKeep — ローカルファーストのリーディング学習ツール。読んでいる内容が、本当に覚えられる単語になります。",
      themeToggle: "ライト/ダークテーマを切り替え",
      nav: { features: "特長", workflow: "使い方", privacy: "プライバシー", languages: "対応言語", support: "貢献する" },
      hero: {
        eyebrow: "ローカルファースト · オープンソース · オフライン対応",
        title: "好きなものを読もう。<br><span class=\"gradient-text\">言葉はそのまま覚えられる。</span>",
        sub: "LexiKeep は、読んでいる内容から語彙を育てるローカルファーストのリーディングツールです。記事や字幕を読みながら、わからない単語をその場で調べ、スマートな復習で定着させましょう。",
        ctaDownload: "無料ダウンロード",
        ctaGithub: "GitHub で見る",
        hint: "左のタブをクリックして各機能をプレビュー"
      },
      mock: {
        windowTitle: "LexiKeep · 読書",
      ...
      features: {
        kicker: "LexiKeep を選ぶ理由",
        title: "調べるために読書をやめるのではなく、<br>読書がそのまま学びになる。",
        sub: "実際に読んでいる内容が中心。その場で理解し、読みながら蓄積し、復習は LexiKeep に任せましょう。"
      },
      f1: {
      ...
      f6: {
        title: "AI はオプション。なくてもすべて使える",
        desc: "AI を使わなくても、インポート・読書・辞書検索・単語保存・復習はすべて利用できます。追加の説明や翻訳が欲しいときだけ有効にできます。"
      },
      roadmap: {
        badge: "2.0.0 · 次期バージョン予告",
        title: "アプリの外で読んでも、単語は LexiKeep へ",
        desc: "計画中のプラグイン機能では、Web ページなどで選択した単語を翻訳し、そのまま LexiKeep の単語リストへ保存できます。読む内容をアプリへ移す必要はありません。",
        p1: "アプリの外で自由に読む",
        p2: "選択した単語を翻訳",
      ...
      cta: {
        ...
        github: "GitHub で見る",
        star: "GitHub で Star ⭐",
        starAsk: "LexiKeep が気に入ったら、GitHub で Star を",
        support: "気に入っていただけたら、GitHub で Star やコントリビューションをお願いします ❤",
        notice: "インストーラーは現在未署名のため、初回インストール時にセキュリティ警告が表示される場合があります。<a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">インストールガイドを見る</a>。"
      },
      footer: { tagline: "LexiKeep · ローカルファーストのリーディング＆語彙学習ツール", github: "GitHub", license: "MIT License", support: "貢献する" },
      dl: {
        kicker: "ダウンロード",
        ...
        note: "インストーラーは未署名のため、初回インストール時にシステムから警告が出る場合がありますが正常です。<a href=\"https://github.com/Pnut-You/LexiKeep/blob/main/DISTRIBUTION.md\" target=\"_blank\" rel=\"noreferrer\">インストールガイドを見る</a>。",
        all: "迷ったら？全リリースを見る →"
      }
    }
  };
  ...
  function updateWindowTitle(dict) {
    var label = getValue(dict, VIEW_LABEL_KEY[currentView]) || "LexiKeep";
    var title = document.querySelector(".window-title");
    if (title) title.textContent = "LexiKeep · " + label;
  }
  ...
  function applyTheme(theme) {
    ...
    if (meta) meta.content = theme === "dark" ? "#100c17" : "#7655b7";
    var toggle = document.querySelector("[data-theme-toggle]");
