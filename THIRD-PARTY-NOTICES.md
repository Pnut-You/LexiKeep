...
LexiKeep bundles derived data from several third-party projects. Each dataset is
...
The PhraseDict data combines the original LexiKeep phrase list with filtered data
from Kaikki's machine-readable English Wiktionary data. See
`PHRASEDICT-LICENSE.txt` for details.

## Third-party software

LexiKeep is built on the following major open-source projects:
...
- If you redistribute LexiKeep or parts of it, keep these notices and the
