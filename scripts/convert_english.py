#!/usr/bin/env python3
"""Generate the LexiKeep built-in English word-form resource from kaikki.org data.
...
LICENSE = textwrap.dedent(
    """\
    LexiKeep built-in English word forms.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate LexiKeep English word forms")
