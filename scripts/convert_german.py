#!/usr/bin/env python3
"""Generate LexiKeep built-in German resources from kaikki.org Wiktionary data.
...
LICENSE = textwrap.dedent(
    """\
    LexiKeep built-in German word forms and English-gloss dictionary.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate LexiKeep German resources")
