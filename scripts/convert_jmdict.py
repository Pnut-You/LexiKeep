#!/usr/bin/env python3
"""Convert JMdict_e.xml to a TSV file for LexiKeep built-in Japanese dictionary.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert JMdict XML to LexiKeep TSV")
